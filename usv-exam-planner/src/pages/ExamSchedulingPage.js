...
function ExamSchedulingPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log("Student details from localStorage:", student);
  
    const email = student?.email || "default_email@student.usv.ro"; // fallback
    const password = "default_password"; // Default password
  
    console.log("Email:", email, "Password:", password);
    console.log("Email sent to backend:", student.email);
    console.log("Password sent to backend:", "default_password");

    if (!email || !password) {
      console.error("Missing email or password!");
      setErrorMessage("Authentication details are missing!");
      return;
    }
    ...
    console.log("Request Payload:", examRequest);
  
    try {
      await createExamRequest(examRequest, email, password);
